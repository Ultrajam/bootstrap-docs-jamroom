...
&lt;a href="#" data-toggle="tooltip" title="first tooltip"&gt;Hover over me&lt;/a&gt;
          ...
          <pre>$('#element').tooltip('show')</pre>

          <h4>.tooltip('hide')</h4>
          <p>Hides an element's tooltip.</p>
          <pre>$('#element').tooltip('hide')</pre>

          <h4>.tooltip('toggle')</h4>
          <p>Toggles an element's tooltip.</p>
          <pre>$('#element').tooltip('toggle')</pre>

          <h4>.tooltip('destroy')</h4>
          <p>Hides and destroys an element's tooltip.</p>
          <pre>$('#element').tooltip('destroy')</pre>
        </section>
      ...
      <section id="popovers">
        ...
        <pre>$('#element').popover('destroy')</pre>
      </section>
      ...
      <div class="bs-docs-section" id="js-alerts">
        ...
        <pre>&lt;a class="close" data-dismiss="alert" href="#"&gt;&times;&lt;/a&gt;</pre>
