...
&lt;/div&gt;
  ...
  <div class="bs-docs-section" id="grid">
    ...
    <p>On mobile devices, the grid starts out stacked. Above 768px, it becomes horizontal as media queries kick in to apply <code>float</code>s and <code>width</code>s. To create a basic grid layout, wrap a series of <code>.col col-lg-*</code> elements within a <code>.row</code>. As this is a 12-column grid, each <code>.col col-lg-*</code> spans a number of those 12 columns, and should always add up to 12 for each row (or the number of columns in the parent), even at mobile resolutions.</p>
...
{/literal}</pre>
    ...
    <p>To nest your content with the default grid, add a new <code>.row</code> and set of <code>.col col-lg-*</code> columns within an existing <code>.col col-lg-*</code> column. Nested rows should include a set of columns that add up to 12.</p>
    <div class="row show-grid">
      <div class="col col-lg-9">
        Level 1: 9 columns
        <div class="row show-grid">
...
&lt;div class="input-group col col-lg-"&gt;
  &lt;span class="input-group-addon"&gt;$&lt;/span&gt;
  &lt;input type="text"&gt;
  &lt;span class="input-group-addon"&gt;.00&lt;/span&gt;
&lt;/div&gt;
...
{/literal}</pre>
    ...
    <p>Use relative sizing classes like <code>.input-large</code> or match your inputs to the grid column sizes using <code>.span*</code> classes. WRONG?????</p>
